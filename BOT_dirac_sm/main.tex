...
\begin{frame}
    ...
    \begin{enumerate}
        \item Check that the Chern number is zero. \visible<5->{\begin{tikzpicture}[scale = 0.4]
...
\begin{frame}
    ...
    \begin{figure}[]
        \centering
        \subfigure{\includegraphics[scale=0.3]{energy_cylinder.png}}
        \subfigure{\includegraphics[scale=0.7]{wannier_bands_demo.png}}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}[t]
        \centering
        \subfigure{\includegraphics[trim= 0 10 0 0, clip,scale=0.45]{wannier_spec_gamma_array_x.png}}
        \subfigure{\includegraphics[scale=0.425]{corner_modes_gamma_x_array.png}}
        \subfigure{\includegraphics[scale=0.45]{spectrum_cylinder_gamma_array.png}}
    \end{figure}
